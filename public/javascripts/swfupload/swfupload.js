...
SWFUpload.prototype.initSettings = function () {
	...
	this.ensureDefault("file_post_name", "data");
	...
	// Flash Settings
	this.ensureDefault("flash_url", "/javascripts/swfupload/Flash/swfupload.swf");
	this.ensureDefault("prevent_swf_caching", true);
	
	// Button Settings
	this.ensureDefault("button_image_url", "/images/admin/browse.png");
